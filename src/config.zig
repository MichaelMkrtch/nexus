...
pub const card_corner_roundness: f32 = 0.3; // card corner rounding (0-1)

// Border settings
pub const border_margin: f32 = 10.0;
pub const outer_margin: f32 = 4.0; // gradient border thickness
pub const gap_margin: f32 = 3.0; // gap between border and card
pub const border_corner_roundness: f32 = 0.28; // gradient border corner rounding (0-1)
